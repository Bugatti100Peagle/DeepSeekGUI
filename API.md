...
* [生成完成](https://www.llamafactory.cn/ollama-docs/api.htm)
* [生成聊天完成](https://www.llamafactory.cn/ollama-docs/api.htm)
* [创建模型](https://www.llamafactory.cn/ollama-docs/api.htm)
* [列出本地模型](https://www.llamafactory.cn/ollama-docs/api.htm)
* [显示模型信息](https://www.llamafactory.cn/ollama-docs/api.htm)
* [复制模型](https://www.llamafactory.cn/ollama-docs/api.htm)
* [删除模型](https://www.llamafactory.cn/ollama-docs/api.htm)
* [拉取模型](https://www.llamafactory.cn/ollama-docs/api.htm)
* [推送模型](https://www.llamafactory.cn/ollama-docs/api.htm)
* [生成嵌入](https://www.llamafactory.cn/ollama-docs/api.htm)
* [列出正在运行的模型](https://www.llamafactory.cn/ollama-docs/api.htm)
...
* `model`: （必需）[模型名称](https://www.llamafactory.cn/ollama-docs/api.htm)
* `prompt`: 生成响应的提示
* `suffix`: 模型响应后的文本
...
* `options`: 文档中列出的 [Modelfile](https://www.llamafactory.cn/ollama-docs/modelfile.htm) 中的其他模型参数，例如 `temperature`
...
通过将 `format` 参数设置为 `json` 来启用 JSON 模式。这将使响应结构化为有效的 JSON 对象。请参阅下面的 JSON 模式 [示例](https://www.llamafactory.cn/ollama-docs/api.htm)。
...
* `format`: 返回响应的格式。目前唯一接受的值是 `json`
* `options`: 文档中列出的其他模型参数，如 [Modelfile](https://www.llamafactory.cn/ollama-docs/modelfile.htm) 中的 `temperature`
...
从一个 [`Modelfile`](https://www.llamafactory.cn/ollama-docs/modelfile.html) 创建模型。建议将 `modelfile` 设置为 Modelfile 的内容，而不仅仅是设置 `path`。这是远程创建的必要条件。远程模型创建还必须使用 [创建 Blob](https://www.llamafactory.cn/ollama-docs/api.htm) 显式地与服务器创建任何文件 blob、字段（如 `FROM` 和 `ADAPTER`），并将响应中指示的路径值设置为路径。
